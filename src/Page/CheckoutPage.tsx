  ...
  return (
    <div className="max-w-[1280px] min-h-screen mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-[17px]">
      ...
      <div className="md:col-span-2 space-y-6">
        ...
        <h2 className="text-2xl font-semibold mt-10">Chọn Hình thức thanh toán</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="border rounded p-4 space-y-2 bg-gray-50 text-right">
          <p>
            Tổng giá trị đơn: <strong>{total.toLocaleString()}đ</strong>
          </p>
          <p>
          ...
          <p className="text-lg font-bold">
            Tổng thanh toán:{' '}
            <span className="text-red-600">{(total + 25000).toLocaleString()}đ</span>
          </p>
        </div>
      </div>
    </div>
